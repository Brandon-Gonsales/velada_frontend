...
const WhatsAppButton = () => {
  // TODO: Reemplaza esta URL con el enlace a tu canal de WhatsApp
  const whatsappChannelUrl = "https://whatsapp.com/channel/0029Vb6ROPSCHDyh450ssf20";
  ...
  return (
    <a
      ...
      aria-label="Ir al canal de votación en WhatsApp"
    >
      <svg
        aria-hidden="true"
        focusable="false"
